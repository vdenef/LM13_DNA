...
rich_Season_boxplot <- ggplot(rich_Season_KW_try, aes(x = Season, y = mean))  +
  ...
  geom_point(aes(color=Season,shape = Station,size = Fraction,fill=Depth_C), position = position_dodge(0.8)) +
  ...
  scale_shape_manual(name = "station", values = c("MLB" = 21, "MM15" = 22, "MM110" = 24),
                     labels = c("Estuary", "Nearshore",  "Offshore")) + 
  scale_size_manual(name = "fraction", breaks = c("B","E"), 
                     labels = c("Free","Particle"),
                     values = c("B" = 2, "E" = 4)) +
  scale_fill_manual(name = "depth",  values = c("D" = "black", "M" = "grey", "S" = "white"), 
