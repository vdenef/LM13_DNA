...
table_env_PA_sqrt <- sqrt(table_env_PA)
table_env_FL <- read.table("Input_data/bioenv_envdata_FL.txt",sep="\t",header=T,row.names=1,as.is=T)
table_env_FL_sqrt <- sqrt(table_env_FL)

bioenv(table_bio, table_env_sqrt, method = "spearman", index = "bray", trace = TRUE, partial = NULL)
bioenv(table_bio_PA, table_env_PA_sqrt, method = "spearman", index = "bray", trace = TRUE, partial = NULL)
bioenv_FL <- bioenv(table_bio_FL, table_env_FL_sqrt, method = "spearman", index = "bray", trace = TRUE, partial = NULL)
summary(bioenv_FL)
x <- 0
...
while (x < 100){
	...
	x <- x + 1
	bioenv_rand <- bioenv(table_bio_rand, table_env_PA_sqrt, method = "spearman", index = "bray", trace = TRUE, partial = NULL)
...
print(max(result))
print('quantiles')
print(quantile(result,0.95))
print(quantile(result,0.99))
