...
pdf(file="Figures/Rplot_BetaDiv_0.1_pcoa.pdf", width= 7, height=3.5, pointsize= 8, colormodel="cmyk", useDingbats = FALSE)
...
```{r final figure 5 PA vs FL betadiv + DEseq and Fig. S2}
library(grid)
library(gridExtra)
...
```{r final figure 6 + S3 by fraction}
library(grid)
library(gridExtra)
...
#for annotating, view table to identify taxa:
View(sigtab.FL.LMvsMLB)
View(sigtab.FL.SpvsSu)
View(sigtab.FL.SuvsFa)
View(sigtab.FL.SvsD)
View(sigtab.PA.LMvsMLB)
View(sigtab.PA.SpvsSu)
View(sigtab.PA.SuvsFa)
View(sigtab.PA.SvsD)
...
```{r Figure S4: plot specific OTUs}
...
select <-physeq_dupmerge.prune.noM %>%
  ...
  subset_taxa(Tribe == "LD12"|Tribe == "Lhab-A1"|Genus == "Nitrosospira"|Phylum =="Chloroflexi"|Genus == "Pnec"|Tribe == "Algor"|Species=="otu000019"|Species=="otu000022"|Tribe == "Algor"|Tribe == "Aquir"|Tribe == "AcI-B1"|Tribe == "LD28"|Family == "LD19"|Family == "Methylophilaceae"|Order=="Methylococcales") %>%
  psmelt()
...
pdf(file="Figures/Rplot_lineplots.pdf", width= 8.5, height=11, pointsize= 8, colormodel="cmyk", useDingbats = FALSE)
grid.arrange(blank,select_plots$Otu000007,select_plots$Otu000008,select_plots$Otu000073,select_plots$Otu000081,select_plots$Otu000460,
             select_plots$Otu000005,select_plots$Otu000010,
