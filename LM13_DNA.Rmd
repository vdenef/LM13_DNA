...
# finally, the plot
pdf(file="Figures/Rplot_Richness_Season_boxplot.pdf", width= 5, height=5, pointsize= 14)
alpha_title <- paste("Richness when rarefied at",min(sample_sums(physeq_dupmerge)),"reads")
rich_Season_boxplot <- ggplot(rich_Season_KW_try, aes(x = Season, y = mean, fill = Season)) + geom_point(size = 2) +
  geom_boxplot()  + ggtitle(alpha_title) +
  geom_text(data = rich_Season_KW_sigs, aes(label = siglabel, x = Season, y = .95), size = 4) +
  scale_fill_manual(name = "", limits=c("Sp", "Su", "Fa"), 
                     values = c("Sp" = "grey","Su" = "grey","Fa" = "grey"))+
  scale_x_discrete(breaks=c("Sp", "Su", "Fa"),
                   labels=c("Spring\n(n=14)","Summer\n(n=17)", "Fall\n(n=16)")) + 
  xlab("Season)") + ylab("Observed Richness") + theme_bw() + 
...
# finally, the plot
pdf(file="Figures/Rplot_Richness_Fraction_boxplot.pdf", width= 5, height=5, pointsize= 14)
alpha_title <- paste("Richness when rarefied at",min(sample_sums(physeq_dupmerge)),"reads")
rich_Fraction_boxplot <- ggplot(rich_Fraction_KW_try, aes(x = Fraction, y = mean, fill = Fraction)) + geom_point(size = 2) +
  geom_boxplot()  + ggtitle(alpha_title) +
  geom_text(data = rich_Fraction_KW_sigs, aes(label = siglabel, x = Fraction, y = .95), size = 4) +
  scale_fill_manual(name = "", limits=c("B", "E"), 
                     values = c("B" = "grey","E" = "grey"))+
  scale_x_discrete(breaks=c("B", "E"),
                   labels=c("Free-living\n(n=24)","Particle-associated\n(n=23)")) + 
  xlab("Fraction)") + ylab("Observed Richness") + theme_bw() + 
  theme(plot.title = element_text(face="bold", size = 12),  #Set the plot title
                                 strip.text.x = element_blank(),  #Set the facet titles on x-axis 
                                 strip.text.y = element_blank(),  #Set the facet titles on x-axis 
                                 strip.background = element_blank(),  #Set the facet background to no background
...
# finally, the plot
pdf(file="Figures/Rplot_Richness_Station_boxplot.pdf", width= 5, height=5, pointsize= 14)
alpha_title <- paste("Richness when rarefied at",min(sample_sums(physeq_dupmerge)),"reads")
rich_Station_boxplot <- ggplot(rich_Station_KW_try, aes(x = Station, y = mean, fill = Station)) + geom_point(size = 2) +
  geom_boxplot()  + ggtitle(alpha_title) +
  geom_text(data = rich_Station_KW_sigs, aes(label = siglabel, x = Station, y = .95), size = 4) +
  scale_fill_manual(name = "", limits=c("MLB", "MM15", "MM110"), 
                     values = c("MLB" = "grey","MM15" = "grey","MM110" = "grey"))+
  scale_x_discrete(breaks=c("MLB", "MM15", "MM110"),
                   labels=c("Estuary\n(n=10)","Nearshore\n(n=18)", "Offshore\n(n=19)")) + 
  xlab("Station)") + ylab("Observed Richness") + theme_bw() + 
  theme(plot.title = element_text(face="bold", size = 12),  #Set the plot title
                                 strip.text.x = element_blank(),  #Set the facet titles on x-axis 
                                 strip.text.y = element_blank(),  #Set the facet titles on x-axis 
                                 strip.background = element_blank(),  #Set the facet background to no background
...
# finally, the plot
pdf(file="Figures/Rplot_Richness_Depth_C_boxplot.pdf", width= 5, height=5, pointsize= 14)
alpha_title <- paste("Richness when rarefied at",min(sample_sums(physeq_dupmerge)),"reads")
rich_Depth_C_boxplot <- ggplot(rich_Depth_C_KW_try, aes(x = Depth_C, y = mean, fill = Depth_C)) + geom_point(size = 2) +
  geom_boxplot()  + ggtitle(alpha_title) +
  geom_text(data = rich_Depth_C_KW_sigs, aes(label = siglabel, x = Depth_C, y = .95), size = 4) +
  scale_fill_manual(name = "", limits=c("S", "M", "D"), 
                     values = c("S" = "grey","M" = "grey","D" = "grey"))+
  scale_x_discrete(breaks=c("S", "M", "D"),
                   labels=c("Surface\n(n=30)","Chla max\n(n=2)","Deep\n(n=15)")) + 
  xlab("Depth_C)") + ylab("Observed Richness") + theme_bw() + 
  theme(plot.title = element_text(face="bold", size = 12),  #Set the plot title
                                 strip.text.x = element_blank(),  #Set the facet titles on x-axis 
                                 strip.text.y = element_blank(),  #Set the facet titles on x-axis 
                                 strip.background = element_blank(),  #Set the facet background to no background
...
# finally, the plot
pdf(file="Figures/Rplot_Evenness_Season_boxplot.pdf", width= 5, height=5, pointsize= 14)
alpha_title <- paste("Evenness when rarefied at",min(sample_sums(physeq_dupmerge)),"reads")
even_Season_boxplot <- ggplot(even_Season_KW_try, aes(x = Season, y = mean, fill = Season)) + geom_point(size = 2) +
  geom_boxplot()  + ggtitle(alpha_title) +
  ...
  scale_x_discrete(breaks=c("Sp", "Su", "Fa"),
                   labels=c("Spring\n(n=14)","Summer\n(n=17)", "Fall\n(n=16)")) + 
  xlab("Season)") + ylab("Simpson's Evenness") + theme_bw() + 
  theme(plot.title = element_text(face="bold", size = 12),  #Set the plot title
                                 strip.text.x = element_blank(),  #Set the facet titles on x-axis 
                                 strip.text.y = element_blank(),  #Set the facet titles on x-axis 
                                 strip.background = element_blank(),  #Set the facet background to no background
...
# finally, the plot
pdf(file="Figures/Rplot_Evenness_Fraction_boxplot.pdf", width= 5, height=5, pointsize= 14)
alpha_title <- paste("Evenness when rarefied at",min(sample_sums(physeq_dupmerge)),"reads")
even_Fraction_boxplot <- ggplot(even_Fraction_KW_try, aes(x = Fraction, y = mean, fill = Fraction)) + geom_point(size = 2) +
  geom_boxplot()  + ggtitle(alpha_title) +
  ...
  scale_x_discrete(breaks=c("B", "E"),
                   labels=c("Free-living\n(n=24)","Particle-associated\n(n=23)")) + 
  xlab("Fraction)") + ylab("Simpson's Evenness") + theme_bw() + 
  theme(plot.title = element_text(face="bold", size = 12),  #Set the plot title
                                 strip.text.x = element_blank(),  #Set the facet titles on x-axis 
                                 strip.text.y = element_blank(),  #Set the facet titles on x-axis 
                                 strip.background = element_blank(),  #Set the facet background to no background
...
# finally, the plot
pdf(file="Figures/Rplot_Evenness_Station_boxplot.pdf", width= 5, height=5, pointsize= 14)
alpha_title <- paste("Evenness when rarefied at",min(sample_sums(physeq_dupmerge)),"reads")
even_Station_boxplot <- ggplot(even_Station_KW_try, aes(x = Station, y = mean, fill = Station)) + geom_point(size = 2) +
  geom_boxplot()  + ggtitle(alpha_title) +
  ...
  scale_x_discrete(breaks=c("MLB", "MM15", "MM110"),
                   labels=c("Estuary\n(n=10)","Nearshore\n(n=18)", "Offshore\n(n=19)")) + 
  xlab("Station)") + ylab("Simpson's Evenness") + theme_bw() + 
  theme(plot.title = element_text(face="bold", size = 12),  #Set the plot title
                                 strip.text.x = element_blank(),  #Set the facet titles on x-axis 
                                 strip.text.y = element_blank(),  #Set the facet titles on x-axis 
                                 strip.background = element_blank(),  #Set the facet background to no background
...
# finally, the plot
pdf(file="Figures/Rplot_Evenness_Depth_C_boxplot.pdf", width= 5, height=5, pointsize= 14)
alpha_title <- paste("Evenness when rarefied at",min(sample_sums(physeq_dupmerge)),"reads")
even_Depth_C_boxplot <- ggplot(even_Depth_C_KW_try, aes(x = Depth_C, y = mean, fill = Depth_C)) + geom_point(size = 2) +
  geom_boxplot()  + ggtitle(alpha_title) +
  ...
  scale_x_discrete(breaks=c("S", "M", "D"),
                   labels=c("Surface\n(n=30)","Chla max\n(n=2)","Deep\n(n=15)")) + 
  xlab("Depth_C)") + ylab("Simpson's Evenness") + theme_bw() + 
  theme(plot.title = element_text(face="bold", size = 12),  #Set the plot title
                                 strip.text.x = element_blank(),  #Set the facet titles on x-axis 
                                 strip.text.y = element_blank(),  #Set the facet titles on x-axis 
                                 strip.background = element_blank(),  #Set the facet background to no background
...
PCoA_DNA_title <- paste("PCoA (Bray-Curtis distance) when considering",ntaxa(physeq.scale),"OTUs")
...
pdf(file="Figures/Rplot_PCOA13_BC_DNA.pdf", width= 20, height=15, pointsize= 14)
pcoa_BC13_DNA <- ggplot(physeq.pcoa.df, aes(Axis.1, Axis.3, color = Season, shape = Station, size = Fraction, fill = Depth_Seas)) +
  ...
  theme(axis.text.x = element_text(colour="black", vjust=0.5, size=14), 
        ...
        legend.text = element_text(size = 12),
        ###LEGEND TOP RIGHT CORNER
        legend.position = "right"); pcoa_BC13_DNA
  dev.off()
...
PCoA_Sor_DNA_title <- paste("PCoA (Sørensen distance) when considering",ntaxa(physeq.prune),"OTUs")

pdf(file="Figures/Rplot_PCOA12_SOR_DNA.pdf", width= 20, height=15, pointsize= 14)
pcoa_SOR12_DNA <- ggplot(physeq.pcoa.sor.df, aes(-Axis.1, -Axis.2, color = Season, shape = Station, size = Fraction, fill = Depth_Seas)) +
  ...
  theme(axis.text.x = element_text(colour="black", vjust=0.5, size=14), 
        ...
        legend.text = element_text(size = 12),
        ###LEGEND TOP RIGHT CORNER
        legend.position = "right"); pcoa_SOR12_DNA
  dev.off()

pdf(file="Figures/Rplot_PCOA13_SOR_DNA.pdf", width= 20, height=15, pointsize= 14)
pcoa_SOR13_DNA <- ggplot(physeq.pcoa.sor.df, aes(-Axis.1, -Axis.3, color = Season, shape = Station, size = Fraction, fill = Depth_Seas)) +
  ...
  theme(axis.text.x = element_text(colour="black", vjust=0.5, size=14), 
        ...
        legend.text = element_text(size = 12),
        ###LEGEND TOP RIGHT CORNER
        legend.position = "right"); pcoa_SOR13_DNA
  dev.off()
...
# plot
pdf(file="Figures/Rplot_cDD_euc_frac_boxplot_toptaxa.pdf", width= 5, height=5, pointsize= 14)
